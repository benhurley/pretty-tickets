export const IntroHero = () => {
    return (
        <div className="max-w-[900px] px-6 pt-16 sm:pt-10 lg:pt-4">
            ...
            <h2 className="text-lg text-gray-800 font-bold italic">Elevate Your Electronic Tickets</h2>
            <p className="text-md mt-4">Transform your recent purchase into a beautiful ticket replica made for gifting.</p>
        </div>
    )
}
