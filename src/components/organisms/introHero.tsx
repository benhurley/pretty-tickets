export const IntroHero = () => {
    return (
        <div className="max-w-[900px] px-6 pt-10 lg:pt-4">
            <>
            ...
            <h2 className="text-lg text-gray-800 font-bold">Elevate Your Electronic Tickets<span className="text-sm absolute">™</span></h2>
            <p className="mt-4 mb-6 sm:my-6">Transform your electronic ticket receipt into a beautiful online replica made for gifting and sharing.</p>
            <div className="flex flex-col md:flex-row gap-4 items-center justify-center">
                <div className="bg-white p-4 rounded-lg shadow-md text-center sm:flex-grow md:w-[200px] md:h-[110px] w-full">
                    ...
                    <p className="text-sm text-gray-600 text-left">Add event details manually or with Generative AI.</p>
                </div>
                <div className="bg-white p-4 rounded-lg shadow-md text-center mt-1 md:mt-0 md:flex-grow md:w-[200px] md:h-[110px] w-full">
                    ...
                    <p className="text-sm text-gray-600 text-left">Get a real-time look at your replica ticket design.</p>
                </div>
                <div className="bg-white p-4 rounded-lg shadow-md text-center mt-1 md:mt-0 md:flex-grow md:w-[200px] md:h-[110px] w-full">
