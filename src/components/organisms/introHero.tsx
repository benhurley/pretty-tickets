export const IntroHero = () => {
    return (
        <div className="max-w-[900px] px-6 pt-10 lg:pt-4 animate-in fade-in zoom-in ease-in-out">
            ...
            <p className="mt-4 mb-6 sm:my-6">Transform your electronic ticket receipt into a beautiful online ticket that's perfect for gifting and sharing.</p>
            <div className="flex flex-col md:flex-row gap-4 items-center justify-center">
                <div className="bg-white p-4 rounded-lg shadow-md text-center sm:flex-grow md:w-[200px] md:h-[110px] w-full">
                    ...
                    <p className="text-sm text-gray-600 text-left">Add your event details with the support of artificial intelligence.</p>
                </div>
