        ...
        <div className="flex flex-col md:flex-row items-center justify-center min-h-screen bg-gradient-to-br from-blue-300 to-pink-200 bg-opacity-50 px-2 py-10 sm:px-10">
            ...
            <div className="flex-1 md:w-1/2 flex flex-col items-center md:items-start justify-center p-10 z-10">
                <>
                    ...
                    <h1 className="text-2xl md:text-3xl lg:text-4xl font-extrabold leading-tight text-gray-700 my-6 animate-in fade-in zoom-in ease-in-out mx-auto text-center max-w-[500px]">{gifterName} sent you tickets to an event!</h1>
                    {giftMessage !== " " && gifterName !== " " && <div className='rounded-xl shadow-2xl bg-white p-4 animate-in fade-in zoom-in ease-in-out mx-auto'>
